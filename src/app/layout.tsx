...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${inter.className} min-h-screen flex bg-[#0f1115] text-[#f8fafc]`}>
        ...
        <aside className="w-64 border-r border-dark-border bg-dark-surface/50 backdrop-blur flex flex-col justify-between hidden md:flex">
          <div>
            ...
            <nav className="p-4 space-y-2 mt-4">
              <Link href="/" className="flex items-center px-4 py-3 rounded-lg hover:bg-white/5 transition-colors text-sm font-medium">
                <Home className="w-4 h-4 mr-3 text-brand-400" />
                Dashboard Overview
              </Link>
              <Link href="/rules" className="flex items-center px-4 py-3 rounded-lg hover:bg-white/5 transition-colors text-sm font-medium">
                <Route className="w-4 h-4 mr-3 text-brand-400" />
                Routing Rules
              </Link>
              <Link href="/analytics" className="flex items-center px-4 py-3 rounded-lg hover:bg-white/5 transition-colors text-sm font-medium">
                <BarChart3 className="w-4 h-4 mr-3 text-brand-400" />
                Traffic Analytics
              </Link>
              <Link href="/security" className="flex items-center px-4 py-3 rounded-lg hover:bg-white/5 transition-colors text-sm font-medium">
          ...
          <div className="p-4 border-t border-dark-border">
            <Link href="/settings" className="flex items-center px-4 py-2 rounded-lg hover:bg-white/5 transition-colors text-sm font-medium text-gray-400">
